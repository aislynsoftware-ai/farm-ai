...
export default function AdminPredictionsPage() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-lg font-bold text-gray-900 dark:text-white">Predictions</h2>
            ...
            <div className="p-4 flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex gap-3">
                <div className="relative">
                  {p.original_image ? (
                    ...
                    <div className="w-28 h-28 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center"><ImageIcon size={24} className="text-emerald-500" /></div>
                  )}
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    <p className="text-sm font-medium text-gray-900 dark:text-white capitalize">{p.crop || 'Unknown'}</p>
                  ...
                  <div className="flex gap-1 shrink-0">
                    <button onClick={() => handleDelete(p.id)} className="p-1.5 rounded bg-gray-100 dark:bg-gray-700 text-red-400 hover:bg-gray-200 dark:hover:bg-gray-600 cursor-pointer"><Trash2 size={12} /></button>
                    <button onClick={() => setExpanded(expanded === p.id ? null : p.id)} className="p-1.5 rounded bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600 cursor-pointer text-xs">{(expanded === p.id ? 'Less' : 'More')}</button>
                  </div>
                </div>
                {p.prediction && (
